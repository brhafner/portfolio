...
const Content = () => {
    ...
    return (
        <Fragment >
            <Typography style={{ fontSize: "28px", margin: "100px 0 30px 0", fontWeight: '600', color: "#0276aa"}}>Software Engineering Projects</Typography>
            <Grid container spacing={4}>
                {sweProjects.map(projectCardObj => getProjectCard(projectCardObj))}
            </Grid>
            <Typography style={{ fontSize: "24px", margin: "30px 0", fontWeight: '600', color: "#0276aa" }}>Product Management Projects</Typography>
            <Grid container spacing={4}>
